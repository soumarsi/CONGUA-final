        ...
        if (net==YES) {
            [urlobj global:str typerequest:@"array" withblock:^(id result, NSError *error,BOOL completed) {
                ...
                if ([[result valueForKey:@"IsSuccess"] integerValue]==1)
                {
                    ...
                    lblDocDesc.text=@"A portfolio is a collection of documents and writing that you assemble in order to demonstrate that you have the appropriate prior and experiential learning to earn university level credit. The portfolio has several parts, described in the next Parts of the Portfolio section.Portfolios can be paper-based or electronically based (e-portfolio). If paper-based, you will follow the guidance given in the section What does a Completed Portfolio Look Like?  The examples provides in the Virtual Portfolio section will also be useful. A portfolio is a collection of documents and writing that you assemble in order to demonstrate that you have the appropriate prior and experiential learning to earn university level credit. The portfolio has several parts, described in the next Parts of the Portfolio section.Portfolios can be paper-based or electronically based (e-portfolio). If paper-based, you will follow the guidance given in the section What does a Completed Portfolio Look Like?  The examples provides in the Virtual Portfolio section will also be useful.";
                     NSString *str=@"A portfolio is a collection of documents and writing that you assemble in order to demonstrate that you have the appropriate prior and experiential learning to earn university level credit. The portfolio has several parts, described in the next Parts of the Portfolio section.Portfolios can be paper-based or electronically based (e-portfolio). If paper-based, you will follow the guidance given in the section What does a Completed Portfolio Look Like?  The examples provides in the Virtual Portfolio section will also be useful. A portfolio is a collection of documents and writing that you assemble in order to demonstrate that you have the appropriate prior and experiential learning to earn university level credit. The portfolio has several parts, described in the next Parts of the Portfolio section.Portfolios can be paper-based or electronically based (e-portfolio). If paper-based, you will follow the guidance given in the section What does a Completed Portfolio Look Like?  The examples provides in the Virtual Portfolio section will also be useful.";
